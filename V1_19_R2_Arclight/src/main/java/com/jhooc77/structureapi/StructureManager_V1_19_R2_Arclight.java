...
public class StructureManager_V1_19_R2_Arclight implements StructureManager {

    final StructureTemplateManager structureManager;

    public StructureManager_V1_19_R2_Arclight() {
        try {
    ...
    public Structure loadStructure(InputStream inputStream) throws IOException {
        return new Structure_V1_19_R2_Arclight(structureManager.m_230404_(NbtIo.m_128939_(inputStream)));
    }
