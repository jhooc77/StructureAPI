...
public class Structure_V1_12_R1 implements Structure {

    final DefinedStructure structure;
    public Structure_V1_12_R1(DefinedStructure structure) {
    ...
    public void place(Location location, boolean spawnEntity, StructureRotation rotation, Mirror mirror, float integrity, Random random) {
        World worldAccess = ((CraftWorld) location.getWorld()).getHandle();
        ...
        DefinedStructureInfo settings = new DefinedStructureInfo()
                ...
                .a(!spawnEntity);
        structure.a(worldAccess, blockPosition, settings, 2);
    }
}
